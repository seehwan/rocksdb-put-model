#!/usr/bin/env python3
"""
시간대별 누적 레벨별 I/O 처리량 분석
Flush부터 각 레벨까지의 I/O 처리량을 시간대별로 누적 분석
"""
...
def analyze_cumulative_level_io(stats_data, compaction_data, flush_data):
    """시간대별 누적 레벨별 I/O 처리량 분석"""
    print("📊 시간대별 누적 레벨별 I/O 처리량 분석 중...")
    ...
    try:
        ...
        plt.tight_layout()
        plt.savefig('cumulative_level_io_analysis.png', dpi=300, bbox_inches='tight')
        plt.close()
        
        print("✅ 시간대별 누적 레벨별 I/O 처리량 분석 시각화 저장 완료: cumulative_level_io_analysis.png")
        
        # 상세 분석 결과 출력
        print("\n📊 시간대별 누적 레벨별 I/O 처리량 분석 결과:")
...
def main():
    """메인 함수"""
    print("🚀 시간대별 누적 레벨별 I/O 처리량 분석 시작...")
    ...
    # 시간대별 누적 레벨별 I/O 처리량 분석
    analyze_cumulative_level_io(stats_data, compaction_data, flush_data)
    
    print("\n✅ 시간대별 누적 레벨별 I/O 처리량 분석 완료!")
